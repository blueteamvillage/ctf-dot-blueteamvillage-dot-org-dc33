        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-gray-900/50 mb-8">
              <TabsTrigger value="overview" className="data-[state=active]:bg-red-500 text-gray-300 hover:text-white">
                <BookOpen className="w-4 h-4 mr-2" />
                Overview
              </TabsTrigger>
              <TabsTrigger value="investigations" className="data-[state=active]:bg-orange-500 text-gray-300 hover:text-white">
                <Target className="w-4 h-4 mr-2" />
                Investigations
              </TabsTrigger>
              <TabsTrigger value="soc" className="data-[state=active]:bg-yellow-500 text-gray-300 hover:text-white">
                <Activity className="w-4 h-4 mr-2" />
                SOC Challenges
              </TabsTrigger>
              <TabsTrigger value="resources" className="data-[state=active]:bg-green-500 text-gray-300 hover:text-white">
                <BookOpen className="w-4 h-4 mr-2" />
                Resources
              </TabsTrigger>
            </TabsList>
